...
- **`state.jsonl`-kohina PR-vahdista — kasvun lähde tukittu (#65), takautuva siivous jäljellä.**
  ...
  **#131:n täydennys tähän sääntöön:** haun epäonnistuminen (`SKIP_UNKNOWN`, §6
  ...
  pysyvästi kummittelemaan (ja mahdollisen #130-skannaussuodatuksen kautta pudottaisi PR:n
  ajosta). Vanhoja rate-limit-episodin aikana kirjattuja vääriä `SKIP_CLOSED`-rivejä ei korjata
  takautuvasti: `pr_last_decision` lukee hännästä, joten ensimmäinen onnistunut luokittelu korjaa
  historian itsestään.
